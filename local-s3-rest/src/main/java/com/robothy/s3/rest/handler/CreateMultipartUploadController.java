 ...
 */
class CreateMultipartUploadController extends BaseController {

  private final CreateMultipartUploadService uploadService;

  private final XmlMapper xmlMapper;

  CreateMultipartUploadController(ServiceFactory serviceFactory, final AuthHandlerService authHandlerService) {
