 ...
 */
class DeleteBucketTaggingController extends BaseController {

  private final BucketService bucketService;

  DeleteBucketTaggingController(ServiceFactory serviceFactory, final AuthHandlerService authHandlerService) {
